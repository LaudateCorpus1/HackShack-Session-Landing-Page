    ...
    <Layout background="/img/generic-background.svg">
      <Box align="start" width="xlarge" direction="column">
        <Box align="start">
          ...
          >
            RULES FOR HPE Hack Shack Workshops
          </Heading>
        </Box>
        ...
        <Text size="xlarge">
          <strong>
            All workshops must be submitted back in to HPE no later than August
        ...
        <br />
        <Text size="xlarge">
          By participating in the HPE HackShack Workshops, participants
